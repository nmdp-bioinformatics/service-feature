...
/**
 * JDBI feature service module.
 */
@Immutable
public final class JdbiFeatureServiceModule extends AbstractModule {
    @Override
    ...
    @Provides @Singleton
    FeatureService createFeatureService(final FeatureDao featureDao) {
